...
# True for bundles generated by the jcode CLI (never the Jcode Desktop app).
is_cli_bundle() {
  [ -f "$1/Contents/Info.plist" ] || return 1
  grep -Eq '<string>com\.jcode\.(app|launcher|notifications)</string>' "$1/Contents/Info.plist"
}
